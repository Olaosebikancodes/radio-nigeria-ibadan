          ...
          {loading ? <p style={{padding:'24px',color:'var(--color-text-muted)'}}>Loadingâ€¦</p>
            ...
            : articles.map(a=>(
              ...
              >
                ...
                <p className="news-col-hide" style={{ fontSize:'12px', color:'var(--color-text-muted)', textTransform:'capitalize' }}>{a.category||'â€”'}</p>
                <p className="news-col-hide" style={{ fontSize:'12px', color:'var(--color-text-muted)', overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap' }}>{a.stations?.name||'â€”'}</p>
