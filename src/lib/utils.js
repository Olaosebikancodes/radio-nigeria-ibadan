...
export const STATIONS_SEED = [
  ...
  { name:'Gold 95.5 FM',      slug:'gold-95-5',      frequency:'95.5',  tagline:'The Jewel of Osun State',     location:'Ilesha, Osun State',     color:'#B8860B', stream_url:'https://centova57.instainternet.com/proxy/gold?mp=/stream',      cover_image:`${IMG}/Gold_FM.jpg-removebg-preview.png` },
